...
extern "C" {
    ...
    IceSword::S_Status instance_init(void* instance_ptr, const bool trans_a, const bool trans_b,
                                           const int m, const int n, const int k);

    IceSword::S_Status instance_dispatch(void* instance_ptr, const float alpha,
