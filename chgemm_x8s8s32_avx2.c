...
inline void block1x16_kernel_avx2(
    ...
    if (0x10 & k_leftover) {
        ...
        //the 0 col
        sum0 = _mm256_madd16epi8_epi32(sum0, ma0_l, mb0_l, mc0, pb0);

        //the 1 col
        sum1 = _mm256_madd16epi8_epi32(sum1, ma0_l, mb1_l, mc1, pb1);

        //the 2 col
        sum2 = _mm256_madd16epi8_epi32(sum2, ma0_l, mb2_l, mc2, pb2);

        //the 3 col
        sum3 = _mm256_madd16epi8_epi32(sum3, ma0_l, mb3_l, mc3, pb3);

        //the 4 col
        sum4 = _mm256_madd16epi8_epi32(sum4, ma0_l, mb4_l, mc4, pb4);

        //the 5 col
        sum5 = _mm256_madd16epi8_epi32(sum5, ma0_l, mb5_l, mc5, pb5);

        //the 6 col
        sum6 = _mm256_madd16epi8_epi32(sum6, ma0_l, mb6_l, mc6, pb6);

        //the 7 col
        sum7 = _mm256_madd16epi8_epi32(sum7, ma0_l, mb7_l, mc7, pb7);

        //the 8 col
        sum8 = _mm256_madd16epi8_epi32(sum8, ma0_l, mb8_l, mc8, pb8);

        //the 9 col
        sum9 = _mm256_madd16epi8_epi32(sum9, ma0_l, mb9_l, mc9, pb9);

        //the 10 col
        sum10 = _mm256_madd16epi8_epi32(sum10, ma0_l, mb10_l, mc10, pb10);

        //the 11 col
        sum11 = _mm256_madd16epi8_epi32(sum11, ma0_l, mb11_l, mc11, pb11);

        //the 12 col
        sum12 = _mm256_madd16epi8_epi32(sum12, ma0_l, mb12_l, mc12, pb12);

        //the 13 col
        sum13 = _mm256_madd16epi8_epi32(sum13, ma0_l, mb13_l, mc13, pb13);

        //the 14 col
        sum14 = _mm256_madd16epi8_epi32(sum14, ma0_l, mb14_l, mc14, pb14);

        //the 15 col
        sum15 = _mm256_madd16epi8_epi32(sum15, ma0_l, mb15_l, mc15, pb15);
    ...
    if (0x08 & k_leftover) {
        ...
        //the 0 col
        sum0 = _mm256_madd8epi8_epi32(sum0, ma0_l, mb0_l, mc0, pb0);

        //the 1 col
        sum1 = _mm256_madd8epi8_epi32(sum1, ma0_l, mb1_l, mc1, pb1);

        //the 2 col
        sum2 = _mm256_madd8epi8_epi32(sum2, ma0_l, mb2_l, mc2, pb2);

        //the 3 col
        sum3 = _mm256_madd8epi8_epi32(sum3, ma0_l, mb3_l, mc3, pb3);

        //the 4 col
        sum4 = _mm256_madd8epi8_epi32(sum4, ma0_l, mb4_l, mc4, pb4);

        //the 5 col
        sum5 = _mm256_madd8epi8_epi32(sum5, ma0_l, mb5_l, mc5, pb5);

        //the 6 col
        sum6 = _mm256_madd8epi8_epi32(sum6, ma0_l, mb6_l, mc6, pb6);

        //the 7 col
        sum7 = _mm256_madd8epi8_epi32(sum7, ma0_l, mb7_l, mc7, pb7);

        //the 8 col
        sum8 = _mm256_madd8epi8_epi32(sum8, ma0_l, mb8_l, mc8, pb8);

        //the 9 col
        sum9 = _mm256_madd8epi8_epi32(sum9, ma0_l, mb9_l, mc9, pb9);

        //the 10 col
        sum10 = _mm256_madd8epi8_epi32(sum10, ma0_l, mb10_l, mc10, pb10);

        //the 11 col
        sum11 = _mm256_madd8epi8_epi32(sum11, ma0_l, mb11_l, mc11, pb11);

        //the 12 col
        sum12 = _mm256_madd8epi8_epi32(sum12, ma0_l, mb12_l, mc12, pb12);

        //the 13 col
        sum13 = _mm256_madd8epi8_epi32(sum13, ma0_l, mb13_l, mc13, pb13);

        //the 14 col
        sum14 = _mm256_madd8epi8_epi32(sum14, ma0_l, mb14_l, mc14, pb14);

        //the 15 col
        sum15 = _mm256_madd8epi8_epi32(sum15, ma0_l, mb15_l, mc15, pb15);
    ...
    //store
    pc0[0] = _mm256_sumepi32_si32(sum0);
    pc0[1] = _mm256_sumepi32_si32(sum1);
    pc0[2] = _mm256_sumepi32_si32(sum2);
    pc0[3] = _mm256_sumepi32_si32(sum3);
    pc0[4] = _mm256_sumepi32_si32(sum4);
    pc0[5] = _mm256_sumepi32_si32(sum5);
    pc0[6] = _mm256_sumepi32_si32(sum6);
    pc0[7] = _mm256_sumepi32_si32(sum7);
    pc0[8] = _mm256_sumepi32_si32(sum8);
    pc0[9] = _mm256_sumepi32_si32(sum9);
    pc0[10] =_mm256_sumepi32_si32(sum10);
    pc0[11] =_mm256_sumepi32_si32(sum11);
    pc0[12] =_mm256_sumepi32_si32(sum12);
    pc0[13] =_mm256_sumepi32_si32(sum13);
    pc0[14] =_mm256_sumepi32_si32(sum14);
    pc0[15] =_mm256_sumepi32_si32(sum15);
}
