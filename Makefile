...
intrinsic_gemm_x8s8s32.i:intrinsic_gemm_x8s8s32.cpp
	@$(C++) -o intrinsic_gemm_x8s8s32.i -E intrinsic_gemm_x8s8s32.cpp -I $(MAKEFILE_DIR) -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm_x8s8s32.s:intrinsic_gemm_x8s8s32.i
	@$(C++) -o intrinsic_gemm_x8s8s32.s -S intrinsic_gemm_x8s8s32.i -fverbose-asm -fPIC -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm_x8s8s32.o:intrinsic_gemm_x8s8s32.s
	@$(C++) -o intrinsic_gemm_x8s8s32.o -c intrinsic_gemm_x8s8s32.s -std=c++11 -O0 -Wall -g

intrinsic_gemm_f32f32f32.i:intrinsic_gemm_f32f32f32.cpp
	@$(C++) -o intrinsic_gemm_f32f32f32.i -E intrinsic_gemm_f32f32f32.cpp -I $(MAKEFILE_DIR) -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm_f32f32f32.s:intrinsic_gemm_f32f32f32.i
	@$(C++) -o intrinsic_gemm_f32f32f32.s -S intrinsic_gemm_f32f32f32.i -fverbose-asm -fPIC -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm_f32f32f32.o:intrinsic_gemm_f32f32f32.s
	@$(C++) -o intrinsic_gemm_f32f32f32.o -c intrinsic_gemm_f32f32f32.s -std=c++11 -O0 -Wall -g

intrinsic_gemm.i:intrinsic_gemm.c
	@$(C++) -o intrinsic_gemm.i -E intrinsic_gemm.c -I $(MAKEFILE_DIR) -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm.s:intrinsic_gemm.i
	@$(C++) -o intrinsic_gemm.s -S intrinsic_gemm.i -fverbose-asm -fPIC -std=c++11 -march=native -O0 -Wall -g
intrinsic_gemm.o:intrinsic_gemm.s
	@$(C++) -o intrinsic_gemm.o -c intrinsic_gemm.s -std=c++11 -O0 -Wall -g
...
intrinsic_gemm_test:libintrinsic_gemm.so libintrinsic_gemm.a
	@$(C++) -o intrinsic_gemm_test intrinsic_gemm_test.cpp -L $(MAKEFILE_DIR) -l intrinsic_gemm -std=c++11 -march=native -Wall -g
